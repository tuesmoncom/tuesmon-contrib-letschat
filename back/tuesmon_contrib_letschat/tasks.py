...
def change_letschathook(url, token, notify_config, obj, change):
    ...
    template_change = loader.get_template('tuesmon_contrib_letschat/change.jinja')
    ...
    # Get markdown fields
    if change.diff:
        template_field = loader.get_template('tuesmon_contrib_letschat/field-diff.jinja')
...
def create_letschathook(url, token, notify_config, obj):
    ...
    template = loader.get_template('tuesmon_contrib_letschat/create.jinja')
...
def delete_letschathook(url, token, notify_config, obj):
    ...
    template = loader.get_template('tuesmon_contrib_letschat/delete.jinja')
    context = Context({"obj": obj, "obj_type": obj_type})
